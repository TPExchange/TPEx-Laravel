<x-layout>
    <h3 class="text-center text-4xl mb-10">Buy {{ $name }}</h3>
    ...
    <section class="mt-5">
        <form method="POST" action="/" class="flex flex-col bg-gray-200 rounded-lg w-lg m-auto py-3 px-10">
            ...
            <h3 class="text-center text-xl">Place A Buy Order</h3>
    ...
    <section class="mt-6">
        <h3 class="text-center text-xl font-bold">Existing Sell Orders</h3>
