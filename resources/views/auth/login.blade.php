<x-layout>
    ...
    <form method="POST" action="/login" class="flex flex-col w-md m-auto mt-10 gap-5">
        ...
        <div class="flex justify-center gap-5 mt-3">
            <button type="reset" class="px-2 py-1 text-lg bg-neutral-700 text-white rounded-md hover:bg-neutral-500 duration-300 cursor-pointer font-bold">Clear</button>
            <button type="submit" class="px-2 py-1 text-lg bg-neutral-300 text-black rounded-md hover:bg-neutral-400 duration-300 cursor-pointer font-bold">Log In</button>
        </div>
