<x-layout>
    ...
    <section class="relative">
        ...
        <a href="/withdraw" class="absolute -top-10 flex items-center text-xl right-0 bg-neutral-700 text-white px-2 py-1 rounded-md hover:bg-neutral-500 duration-300 cursor-pointer font-bold">Withdraw Items</a>
